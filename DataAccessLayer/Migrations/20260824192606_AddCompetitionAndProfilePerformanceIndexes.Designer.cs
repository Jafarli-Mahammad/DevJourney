...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20260824192606_AddCompetitionAndProfilePerformanceIndexes")]
    partial class AddCompetitionAndProfilePerformanceIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Entities.Company.CompanyInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CompanyInvitations", "Identity");
                });
            ...
            modelBuilder.Entity("Domain.Models.Entities.Competition.CheckInLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CheckInLogs", "Identity");
                });
            ...
            modelBuilder.Entity("Domain.Models.Entities.Competition.Competition", b =>
                {
                    ...
                    b.Property<string>("AgendaMode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AgendaPdfUrl")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ContactSocialLink")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("GitHubRepositoryRequirement")
                        .HasColumnType("int");

                    b.Property<bool>("IsCertificatesPublished")
                        .HasColumnType("bit");

                    b.Property<bool>("IsJuryActive")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("IsScoreboardLive")
                        .HasColumnType("bit");

                    b.Property<int>("LiveDeploymentRequirement")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ParticipationFormat")
                        .HasColumnType("int");

                    b.Property<Guid>("PartnerId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("PitchDeckFormat")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.Entities.Competition.Criterion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.Entities.Competition.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.Entities.Core.Broadcast", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Broadcasts", "Identity");
                });

            modelBuilder.Entity("Domain.Models.Entities.Core.Certificate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("IssuedByPartnerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.Entities.Core.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.Entities.Core.SupportMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SupportMessages", "Identity");
                });

            modelBuilder.Entity("Domain.Models.Entities.Core.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SupportTickets", "Identity");
                });
            ...
            modelBuilder.Entity("Domain.Models.Entities.Student.MainRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MainRoles", "Student");
                });

            modelBuilder.Entity("Domain.Models.Entities.Student.Profession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.Entities.Competition.Competition", b =>
                {
                    b.HasOne("Domain.Models.Entities.Partner.PartnerProfile", "Partner")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Models.Entities.Competition.CompetitionStage", b =>
                {
                    b.HasOne("Domain.Models.Entities.Competition.Competition", "Competition")
                        .WithMany("Stages")
            ...
            modelBuilder.Entity("Domain.Models.Entities.Competition.CompetitionTeamMember", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Entities.Competition.Team", "Team")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Domain.Models.Entities.Core.SupportMessage", b =>
                {
                    b.HasOne("Domain.Models.Entities.Core.SupportTicket", "SupportTicket")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Domain.Models.Entities.Student.StudentProfile", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Entities.Student.MainRole", "MainRole")
                        .WithMany()
                        .HasForeignKey("MainRoleId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Domain.Models.Entities.Student.Profession", "Profession")
                        .WithMany()
                        .HasForeignKey("ProfessionId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Domain.Models.Entities.University.UniversityProfile", "University")
                        .WithMany()
